    ...
    <div class="about-section about-section-gray">
      <div class="about-section-inner">
        ...
        <div class="formation-grid">
          <div class="goose-card"><div class="goose-card-name">🪿 Assistenty</div><div class="goose-card-role">Primary orchestrator</div><div class="goose-card-desc">Assists the director and every goose wherever she can. When there's a party, Assistenty does most of the honking.</div></div>
