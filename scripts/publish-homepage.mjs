...
async function generateHomepage() {
  ...
  const AGENT_COLORS   = { assistenty:'#6366f1', devy:'#0ea5e9', finny:'#10b981', ay:'#f59e0b', jurry:'#8b5cf6', secury:'#ef4444', testy:'#ec4899', commy:'#f97316', designy:'#a855f7', nosty:'#06b6d4', docy:'#64748b', transy:'#e11d48', healthy:'#22c55e', backy:'#1e40af', coachy:'#d97706' , gander:'#374151' , cssy:'#374151' , thinky:'#374151' , creaty:'#374151'  , toddy:'#374151'  , welcome:'#374151'  , splitty:'#374151'  };
